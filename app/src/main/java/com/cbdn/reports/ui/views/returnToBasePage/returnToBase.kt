package com.cbdn.reports.ui.views.returnToBasePage
...
fun ReturnToBase(
    ...
    // TODO: Implement dynamic base location tracking
    ...
    // Get the icon
    val bmpIcon = AppCompatResources.getDrawable(
        context,
    ...
    val intent = Intent(
        Intent.ACTION_VIEW,
        Uri.parse("google.navigation:q=${baseLocation.latitude},${baseLocation.longitude}&model=d")
    )
    ...
    Column(
        ...
        GoogleMap(
            ...
            if (bmpIcon != null) {
                ...
                Marker(
                    state = MarkerState(position = baseLocation)
                )
            } else {
                Marker(
                    state = MarkerState(position = baseLocation)
        ...
        MenuButton(
            ...
            labelResource = R.string.navigate_base,
            subLabelResource = R.string.navigate_base_description,
